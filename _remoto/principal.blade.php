...
<head>
    ...
    <link href="{{ asset('public/css/sm-core-css.css') }}" rel='stylesheet' type='text/css' />
    <!-- "sm-blue" menu theme (optional, you can use your own CSS, too) -->
    <link href="{{ asset('public/css/sm-blue.css') }}" rel='stylesheet' type='text/css' />

    <link rel="shortcut icon" href="{{ asset('http://secretaria.junshin.com.br/public/img/junshin_logo_2.png') }}">
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    <h1>
                        <img style="display: inline-block;" src="http://secretaria.junshin.com.br/public/img/junshin_logo_2.png" alt="Imagem do Junshin">
