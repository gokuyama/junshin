...
<button type="button" class="btn btn-primary" style="margin-bottom: 10px;"
    onclick="location.href='{{route('niveisConhecimentoJapones.novo')}}'">Adicionar Nível de Conhecimento de
    Japonês</button>
<table class="table table-striped table-bordered table-hover">
    ...
    <tr>
        ...
        <td class="col-sm-2"> <a
                href="{{action('NivelConhecimentoJaponesController@edita', $n->nivel_conhecimento_japones_id)}}">
