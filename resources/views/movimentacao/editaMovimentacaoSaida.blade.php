...
<h1>Editando saída:</h1>
<form action="{{action('MovimentacaoController@alteraSaida',$t->movimentacao_id)}}" method="get">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                        onclick="location.href='{{action('MovimentacaoController@excluiSaida', $t->movimentacao_id)}}'">Sim</button>
                    </a>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Não</button>
                </div>
            </div>
