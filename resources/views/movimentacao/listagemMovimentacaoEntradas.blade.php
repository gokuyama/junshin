...
<button type="button" class="btn btn-primary" style="margin-bottom: 10px;"
    onclick="location.href='{{route('movimentacoes.nova.entrada')}}'">Adicionar nova entrada</button>
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tr>
        ...
        <td class="col-sm-2"> <a href="{{action('MovimentacaoController@editaEntrada', $t->movimentacao_id)}}">
